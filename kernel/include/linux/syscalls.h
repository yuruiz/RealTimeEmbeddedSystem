...
/*
 * Syscall declaration for 18-648
 */
struct proc_struct;
struct energy_struct;
asmlinkage long sys_calc(unsigned int n1, unsigned int n2, char op);
asmlinkage long sys_count_rt_threads(void);
asmlinkage long sys_list_rt_threads(struct proc_struct* list, int len);
...
asmlinkage long sys_get_energy_info(pid_t tid, struct energy_struct* energy_info);
