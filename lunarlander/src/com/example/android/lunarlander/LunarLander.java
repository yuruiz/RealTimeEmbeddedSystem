...
public class LunarLander extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toUp=(ImageButton)findViewById(R.id.toup);

        toLeft.setOnTouchListener(new View.OnTouchListener() {
		@Override
		public boolean onTouch(android.view.View arg0, MotionEvent event) {
     ...
     // this goes wherever you setup your button listener:
        toUp.setOnTouchListener(new View.OnTouchListener() {
			@Override
			public boolean onTouch(android.view.View arg0, MotionEvent event) {
				if(event.getAction() == MotionEvent.ACTION_DOWN) {
